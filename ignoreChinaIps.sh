...
iptables -t nat -A SHADOWSOCKS -d 107.170.208.101 -j RETURN
iptables -t nat -A SHADOWSOCKS -d 50.116.9.35 -j RETURN
iptables -t nat -A SHADOWSOCKS -d 106.187.97.14 -j RETURN
...
#iptables -t nat -A SHADOWSOCKS -p udp -j REDIRECT --to-ports 12345
